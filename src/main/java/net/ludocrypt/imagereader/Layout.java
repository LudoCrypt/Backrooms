...
public class Layout {
	...
	public static List<Integer[][]> listLayouts(int max, String room, int blackBlock, int whiteBlock, @Nullable int red,
			@Nullable int red2, @Nullable int green, @Nullable int green2, @Nullable int blue, @Nullable int blue2,
			@Nullable int purple, @Nullable int purple2) {
	...
	private static void colorChecker(Color c, List<Integer> list, int black, int white, @Nullable int red,
			@Nullable int red2, @Nullable int green, @Nullable int green2, @Nullable int blue, @Nullable int blue2,
			@Nullable int purple, @Nullable int purple2) {

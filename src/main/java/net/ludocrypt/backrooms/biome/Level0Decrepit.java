...
public class Level0Decrepit extends Biome {
	protected static final BlockState WALL = Backrooms.WALL.getDefaultState();
	public static final Decorator<NopeDecoratorConfig> LEVEL0DECREPITPLACER = new Level0RoomDecorator(
			NopeDecoratorConfig.field_24891);

	public Level0Decrepit() {
		...
		this.addFeature(GenerationStep.Feature.LOCAL_MODIFICATIONS,
				LevelsFeatureInit.LEVEL0DECREPITROOM.configure(FeatureConfig.DEFAULT)
						.createDecoratedFeature(LEVEL0DECREPITPLACER.configure(DecoratorConfig.DEFAULT)));

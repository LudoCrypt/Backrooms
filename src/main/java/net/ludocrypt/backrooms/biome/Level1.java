...
public class Level1 extends Biome {
	protected static final BlockState WALL = Backrooms.WALL.getDefaultState();
	public static final Decorator<NopeDecoratorConfig> LEVEL1PLACER = new Level1RoomDecorator(NopeDecoratorConfig::deserialize);

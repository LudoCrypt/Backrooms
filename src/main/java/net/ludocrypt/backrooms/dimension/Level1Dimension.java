...
public class Level1Dimension extends Dimension {
	private static final Vec3d FOG_COLOR = new Vec3d(0.4, 0.4, 0.4);

	public Level1Dimension(World world, DimensionType type) {
	...
	public ChunkGenerator<?> createChunkGenerator() {
		OverworldChunkGeneratorConfig generatorConfig = Level1Dimension.getDefaultConfig();
		FixedBiomeSourceConfig biomeConfig = BiomeSourceType.FIXED.getConfig(world.getLevelProperties())
				.setBiome(Backrooms.LEVEL1);
	...
	public DimensionType getType() {
		return BackroomsDimensionTypes.LEVEL1;
	}

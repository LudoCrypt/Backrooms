...
public class Level3Dimension extends Dimension {
	private static final Vec3d FOG_COLOR = new Vec3d(1, 1, 1);

	public Level3Dimension(World world, DimensionType type) {
	...
	public ChunkGenerator<?> createChunkGenerator() {
		OverworldChunkGeneratorConfig generatorConfig = Level3Dimension.getDefaultConfig();
		FixedBiomeSourceConfig biomeConfig = BiomeSourceType.FIXED.getConfig(world.getLevelProperties())
				.setBiome(Backrooms.LEVEL3);
	...
	public DimensionType getType() {
		return BackroomsDimensionTypes.LEVEL3;
	}

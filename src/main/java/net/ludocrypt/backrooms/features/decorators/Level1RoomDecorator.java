...
public class Level1RoomDecorator extends Decorator<NopeDecoratorConfig> {

	public Level1RoomDecorator(Function<Dynamic<?>, ? extends NopeDecoratorConfig> configFactory) {
		super(configFactory);
	}

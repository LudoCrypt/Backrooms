...
public class Level0DottedRoom extends Feature<DefaultFeatureConfig> {
	public Level0DottedRoom(Function<Dynamic<?>, ? extends DefaultFeatureConfig> configFactory) {
		super(configFactory);
	}
	...
	private static final BlockState WALLPAPER = Backrooms.DOTTED_WALLPAPER.getDefaultState();
	...
	private static final BlockState TORN_WALLPAPER_1 = Backrooms.DOTTED_TORN_WALLPAPER.getDefaultState()
			.with(TornWallpaper.TORN_LEVEL, 1);
	private static final BlockState TORN_WALLPAPER_2 = Backrooms.DOTTED_TORN_WALLPAPER.getDefaultState()
			.with(TornWallpaper.TORN_LEVEL, 2);
	private static final BlockState TORN_WALLPAPER_3 = Backrooms.DOTTED_TORN_WALLPAPER.getDefaultState()
			.with(TornWallpaper.TORN_LEVEL, 3);
	private static final BlockState TORN_WALLPAPER_4 = Backrooms.DOTTED_TORN_WALLPAPER.getDefaultState()
			...
			for (int z = 0; z < slice[0].length; z++) {
				...
				if (((world.getBlockState(currentPosition).getBlock() == Backrooms.WALL)
					...
					if ((generator.nextDouble()) < ((BackroomsConfig.getInstance().Level0DoorChance))) {
						...
						Level0DottedRoom.door1 = false;
					}
					if ((generator.nextDouble()) < ((BackroomsConfig.getInstance().Level0DoorChance))) {
						Level0DottedRoom.door2 = true;
					} else {
						Level0DottedRoom.door2 = false;
					}
					if ((generator.nextDouble()) < ((BackroomsConfig.getInstance().Level0DoorChance))) {
						Level0DottedRoom.door3 = true;
					} else {
						Level0DottedRoom.door3 = false;
					}
					if ((generator.nextDouble()) < ((BackroomsConfig.getInstance().Level0DoorChance))) {
						Level0DottedRoom.door4 = true;
					} else {
						Level0DottedRoom.door4 = false;
					}

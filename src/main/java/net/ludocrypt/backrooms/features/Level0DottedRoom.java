...
public class Level0DottedRoom extends Feature<DefaultFeatureConfig> {
	...
	private static final BlockState WALLPAPER = Backrooms.WALLPAPER.getDefaultState().with(Wallpaper.DOTTED, true).with(Wallpaper.RED, false);

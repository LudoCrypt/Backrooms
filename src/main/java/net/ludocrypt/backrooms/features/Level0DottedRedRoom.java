...
public class Level0DottedRedRoom extends Feature<DefaultFeatureConfig> {
	public Level0DottedRedRoom(Codec<DefaultFeatureConfig> configFactory) {
		super(configFactory);
	}
	...
	private static final BlockState TORN_WALLPAPER_1 = Backrooms.DOTTED_RED_TORN_WALLPAPER.getDefaultState()
			.with(TornWallpaper.TORN_LEVEL, 1);
	private static final BlockState TORN_WALLPAPER_2 = Backrooms.DOTTED_RED_TORN_WALLPAPER.getDefaultState()
			.with(TornWallpaper.TORN_LEVEL, 2);
	private static final BlockState TORN_WALLPAPER_3 = Backrooms.DOTTED_RED_TORN_WALLPAPER.getDefaultState()
